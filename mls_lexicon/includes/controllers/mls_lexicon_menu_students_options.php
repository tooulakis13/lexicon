<?php
/*
 *	MLS Lexicon Student options Panel
 *	MLS Lexicon settings
 */
if(isset($_REQUEST['submit']) and $_REQUEST['submit'])
{
  /* Update options */
  update_option("mls_lexicon_estu_size", @$_POST['estu_size'] );
  update_option("mls_lexicon_orden_flashcards", @$_POST['orden_flashcards'] );
  update_option("mls_lexicon_presentacion_flashcards", @$_POST['presentacion_flashcards']);
  update_option("mls_lexicon_realizar_curso", @$_POST['realizar_curso'] );
  update_option("mls_lexicon_mostrar_estadisticas", @$_POST['mostrar_estadisticas'] );
  update_option("mls_lexicon_algoritmo", @$_POST['algoritmo'] );
...
<div class="wrap">
  <h2><?php _e("Lexicon Options", 'mls_lexicon'); ?></h2>
  <div class="postbox-container" style="width:73%;margin-right:2%;">	
    <!-- <p><?php _e('Go to', 'mls_lexicon')?> <a href="tools.php?page=mls_lexicon_exams"><?php _e('Manage Your Exams', 'mls_lexicon')?></a></p> -->
    ...
    <div id="poststuff">
      <div id="postdiv" class="postarea">
        ...
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Tamaño de la letra', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $estu_size = get_option('mls_lexicon_estu_size');
            ?>
		    ...
		    onclick="festu_size(1)"/>&nbsp;<?php _e('Tamaño pequeño.', 'mls_lexicon')?> </label><br>
		    <label>&nbsp;<input id ="estu_size2" type='checkbox' value="1" <?php if($estu_size == "16") echo 'checked'?>
		    onclick="festu_size(2)"
		    />&nbsp;<?php _e('Tamaño normal.', 'mls_lexicon')?> </label><br>
		    <label>&nbsp;<input id ="estu_size3" type='checkbox' value="1" <?php if($estu_size == "20") echo 'checked'?>
		    onclick="festu_size(3)"
		    />&nbsp;<?php _e('Tamaño grande.', 'mls_lexicon')?> </label>
		  </div>
	   </div>

	   <!-- Modificar el orden de las flashcards-->
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Orden de las flashcards', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $orden_flashcards = get_option('mls_lexicon_orden_flashcards');
            ?>
		    ...
		    onclick="forden_flashcards(1)"/>&nbsp;<?php _e('Primero el idioma base.', 'mls_lexicon')?> </label><br>
		    ...
		    />&nbsp;<?php _e('Primero el idioma a aprender.', 'mls_lexicon')?> </label><br>
		    ...
		    />&nbsp;<?php _e('Aleatorio.', 'mls_lexicon')?> </label>
		  </div>
	   </div>

	   <!-- Modificar la presentación de las flashcards-->
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Presentación de las flashcards', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $presentacion_flashcards = get_option('mls_lexicon_presentacion_flashcards');
            ?>
		    ...
		    onclick="fpresentacion_flashcards(1)"/>&nbsp;<?php _e('Pulsar botones.', 'mls_lexicon')?> </label><br>
		    ...
		    />&nbsp;<?php _e('Escribir respuesta y comprobar.', 'mls_lexicon')?> </label><br>
	   ...
	   <!-- Modificar la forma de realizar el curso-->
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Forma de realizar el curso', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $realizar_curso = get_option('mls_lexicon_realizar_curso');
            ?>
		    ...
		    onclick="frealizar_curso(1)"/>&nbsp;<?php _e('Realizar el curso por categorías.', 'mls_lexicon')?> </label><br>
		    ...
		    />&nbsp;<?php _e('Realizar el curso completo.', 'mls_lexicon')?> </label>
		  </div>
	   </div>

	   <!-- Mostrar estadísticas en el gráfico de curso-->
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Estadísticas en el gráfico del curso', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $mostrar_estadisticas = get_option('mls_lexicon_mostrar_estadisticas');
            ?>
		    ...
		    onclick="fmostrar_estadisticas(1)"/>&nbsp;<?php _e('Con estadísticas.', 'mls_lexicon')?> </label><br>
		    ...
		    />&nbsp;<?php _e('Sin estadísticas.', 'mls_lexicon')?> </label>
		  </div>
	   </div>

	   <!-- Utilizar el algoritmo de repetición espaciada o no-->
        <div class="postbox">
          <h3 class="hndle"><span><?php _e('Algoritmo de repeteción espaciada', 'mls_lexicon') ?></span></h3>
          <div class="inside" style="padding:8px">
            <?php
              $algoritmo = get_option('mls_lexicon_algoritmo');
            ?>
		    ...
		    onclick="falgoritmo(1)"/>&nbsp;<?php _e('Usar el algoritmo de repectición espaciada para estudiar los cursos.', 'mls_lexicon')?> </label><br>
		    <label>&nbsp;<input id ="algoritmo2" type='checkbox' value="1" <?php if($algoritmo == "0") echo 'checked'?>
		    onclick="falgoritmo(2)"
		    />&nbsp;<?php _e('Usar un orden fijado para estudiar el curso.', 'mls_lexicon')?> </label>
		  </div>
	   </div>
	...
	<input type="submit" name="submit" value="<?php _e('Guardar cambios', 'mls_lexicon') ?>" style="font-weight: bold;" />
	</p>
	...
	<div id="mls_lexicon-sidebar">
			<?php include(mls_lexicon_DIR."/includes/views/mls_lexicon_sidebar.php");?>
	</div>
</div>
